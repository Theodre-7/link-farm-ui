...
import { Send, ArrowLeft, MoreVertical, Phone, Video, Home } from 'lucide-react';
...
const Messages = () => {
  ...
  const isBuyer = location.pathname.includes('/buyer') || 
                  document.referrer.includes('/buyer') || 
  ...
  if (!selectedChat) {
    return (
      <div className="h-screen bg-agri-cream flex flex-col">
        ...
        <div className="bg-white border-b border-agri-blue/20 shadow-sm p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Button
              variant="ghost"
              onClick={handleReturnHome}
              className="text-agri-green hover:bg-agri-green/10 min-h-[44px]"
            >
        ...
        {isBuyer ? <BuyerBottomNavigation /> : <BottomNavigation />}
      </div>
    );
  }
  ...
  return (
    <div className="h-screen bg-agri-cream flex">
      ...
      <div className={cn(
        ...
        <div className="p-4 border-b border-agri-blue/20 flex items-center justify-between">
          <h1 className="text-xl font-bold text-agri-brown">Messages</h1>
          <Button
            variant="ghost"
            onClick={handleReturnHome}
            className="text-agri-green hover:bg-agri-green/10 min-h-[44px] md:hidden"
          >
            <Home className="w-5 h-5 mr-2" />
            Home
          </Button>
      ...
      <div className={cn(
        ...
        <div className="bg-white border-b border-agri-blue/20 p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <Button
              variant="ghost"
              onClick={handleReturnHome}
              className="text-agri-green hover:bg-agri-green/10 min-h-[44px] hidden md:flex"
            >
              <Home className="w-5 h-5 mr-2" />
              Home
            </Button>
        ...
        {/* Messages */}
        <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-agri-cream/30 pb-32">
